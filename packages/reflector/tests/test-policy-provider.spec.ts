...
describe("Policy Provider tests", () => {
    ...
    it("test default access policies 1", () => {
        ...
        expect(policyProvider.hasAccessPolicy(PrimitiveMetadataAccessPolicy.INST_METHOD)).toBeTruthy();
        expect(policyProvider.hasAccessPolicy(PrimitiveMetadataAccessPolicy.STATIC_METHOD)).toBeTruthy();
        expect(policyProvider.hasAccessPolicy(PrimitiveMetadataAccessPolicy.INST_PROPERTY)).toBeTruthy();
        expect(policyProvider.hasAccessPolicy(PrimitiveMetadataAccessPolicy.STATIC_PROPERTY)).toBeTruthy();
        expect(policyProvider.hasAccessPolicy(PrimitiveMetadataAccessPolicy.INST_ACCESSOR)).toBeTruthy();
        ...
        expect(policyProvider.hasAccessPolicy(PrimitiveMetadataAccessPolicy.PARAMETER_IN_INST_METHOD)).toBeTruthy();
    });
    ...
    it("test default access policies 3", () => {
        ...
        expect(policyProvider.hasAccessPolicy(PrimitiveMetadataAccessPolicy.INST_METHOD)).toBeFalsy();
        expect(policyProvider.hasAccessPolicy(PrimitiveMetadataAccessPolicy.STATIC_METHOD)).toBeFalsy();
        expect(policyProvider.hasAccessPolicy(PrimitiveMetadataAccessPolicy.INST_PROPERTY)).toBeFalsy();
        expect(policyProvider.hasAccessPolicy(PrimitiveMetadataAccessPolicy.STATIC_PROPERTY)).toBeFalsy();
        expect(policyProvider.hasAccessPolicy(PrimitiveMetadataAccessPolicy.INST_ACCESSOR)).toBeFalsy();
        ...
        expect(policyProvider.hasAccessPolicy(PrimitiveMetadataAccessPolicy.PARAMETER_IN_INST_METHOD)).toBeFalsy();
    });
    ...
    it("test set/get collision policies ", () => {
        ...
        expect(policyProvider.getCollisionPolicy(PrimitiveMetadataAccessPolicy.PARAMETER_IN_INST_METHOD)).toBe(MetadataCollisionPolicy.DEFAULT);
        ...
        expect(policyProvider.getCollisionPolicy(PrimitiveMetadataAccessPolicy.PARAMETER_IN_INST_METHOD)).toBe(MetadataCollisionPolicy.SKIP);

        policyProvider.addCollisionPolicy(MetadataCollisionPolicy.JOIN, MetadataAccessPolicy.PARAMETER_IN_INST_METHOD);

        expect(policyProvider.getCollisionPolicy(PrimitiveMetadataAccessPolicy.CONSTRUCTOR)).toBe(MetadataCollisionPolicy.DEFAULT);
        expect(policyProvider.getCollisionPolicy(PrimitiveMetadataAccessPolicy.PARAMETER_IN_CONSTRUCTOR)).toBe(MetadataCollisionPolicy.SKIP);
        expect(policyProvider.getCollisionPolicy(PrimitiveMetadataAccessPolicy.PARAMETER_IN_STATIC_METHOD)).toBe(MetadataCollisionPolicy.SKIP);
        expect(policyProvider.getCollisionPolicy(PrimitiveMetadataAccessPolicy.PARAMETER_IN_INST_METHOD)).toBe(MetadataCollisionPolicy.JOIN);

        policyProvider.setCollisionPolicy(MetadataCollisionPolicy.THROW_ERROR, MetadataAccessPolicy.PARAMETER_IN_INST_METHOD);

        expect(policyProvider.getCollisionPolicy(PrimitiveMetadataAccessPolicy.CONSTRUCTOR)).toBe(MetadataCollisionPolicy.DEFAULT);
        expect(policyProvider.getCollisionPolicy(PrimitiveMetadataAccessPolicy.PARAMETER_IN_CONSTRUCTOR)).toBe(MetadataCollisionPolicy.DEFAULT);
        expect(policyProvider.getCollisionPolicy(PrimitiveMetadataAccessPolicy.PARAMETER_IN_STATIC_METHOD)).toBe(MetadataCollisionPolicy.DEFAULT);
        expect(policyProvider.getCollisionPolicy(PrimitiveMetadataAccessPolicy.PARAMETER_IN_INST_METHOD)).toBe(MetadataCollisionPolicy.THROW_ERROR);
    });
    ...
    it("test set/get appearance policies ", () => {
        ...
        expect(policyProvider.getAppearancePolicy(PrimitiveMetadataAccessPolicy.PARAMETER_IN_INST_METHOD)).toBe(MetadataAppearancePolicy.DEFAULT);
        ...
        expect(policyProvider.getAppearancePolicy(PrimitiveMetadataAccessPolicy.PARAMETER_IN_INST_METHOD)).toBe(MetadataAppearancePolicy.SKIP);

        policyProvider.addAppearancePolicy(MetadataAppearancePolicy.APPLY, MetadataAccessPolicy.PARAMETER_IN_INST_METHOD);

        expect(policyProvider.getAppearancePolicy(PrimitiveMetadataAccessPolicy.CONSTRUCTOR)).toBe(MetadataAppearancePolicy.DEFAULT);
        expect(policyProvider.getAppearancePolicy(PrimitiveMetadataAccessPolicy.PARAMETER_IN_CONSTRUCTOR)).toBe(MetadataAppearancePolicy.SKIP);
        expect(policyProvider.getAppearancePolicy(PrimitiveMetadataAccessPolicy.PARAMETER_IN_STATIC_METHOD)).toBe(MetadataAppearancePolicy.SKIP);
        expect(policyProvider.getAppearancePolicy(PrimitiveMetadataAccessPolicy.PARAMETER_IN_INST_METHOD)).toBe(MetadataAppearancePolicy.APPLY);

        policyProvider.setAppearancePolicy(MetadataAppearancePolicy.SKIP, MetadataAccessPolicy.PARAMETER_IN_INST_METHOD);
    ...
    it("test set/get same target multi usage policies ", () => {
        ...
        expect(policyProvider.getSameTargetMultiUsagePolicy(PrimitiveMetadataAccessPolicy.PARAMETER_IN_INST_METHOD)).toBe(MetadataSameTargetMultiUsagePolicy.DEFAULT);
        ...
        expect(policyProvider.getSameTargetMultiUsagePolicy(PrimitiveMetadataAccessPolicy.PARAMETER_IN_INST_METHOD)).toBe(MetadataSameTargetMultiUsagePolicy.ALLOWED);

        policyProvider.addSameTargetMultiUsagePolicy(MetadataSameTargetMultiUsagePolicy.NOT_ALLOWED, MetadataAccessPolicy.PARAMETER_IN_INST_METHOD);

        expect(policyProvider.getSameTargetMultiUsagePolicy(PrimitiveMetadataAccessPolicy.CONSTRUCTOR)).toBe(MetadataSameTargetMultiUsagePolicy.DEFAULT);
        expect(policyProvider.getSameTargetMultiUsagePolicy(PrimitiveMetadataAccessPolicy.PARAMETER_IN_CONSTRUCTOR)).toBe(MetadataSameTargetMultiUsagePolicy.ALLOWED);
        expect(policyProvider.getSameTargetMultiUsagePolicy(PrimitiveMetadataAccessPolicy.PARAMETER_IN_STATIC_METHOD)).toBe(MetadataSameTargetMultiUsagePolicy.ALLOWED);
        expect(policyProvider.getSameTargetMultiUsagePolicy(PrimitiveMetadataAccessPolicy.PARAMETER_IN_INST_METHOD)).toBe(MetadataSameTargetMultiUsagePolicy.NOT_ALLOWED);

        policyProvider.setSameTargetMultiUsagePolicy(MetadataSameTargetMultiUsagePolicy.ALLOWED, MetadataAccessPolicy.PARAMETER_IN_INST_METHOD);
    ...
    it("test set/get not existence policies ", () => {
        ...
        expect(policyProvider.getNotExistencePolicy(PrimitiveMetadataAccessPolicy.PARAMETER_IN_INST_METHOD)).toBe(MetadataNotExistencePolicy.DEFAULT);
        ...
        expect(policyProvider.getNotExistencePolicy(PrimitiveMetadataAccessPolicy.PARAMETER_IN_INST_METHOD)).toBe(MetadataNotExistencePolicy.SKIP);

        policyProvider.addNotExistencePolicy(MetadataNotExistencePolicy.APPLY, MetadataAccessPolicy.PARAMETER_IN_INST_METHOD);

        expect(policyProvider.getNotExistencePolicy(PrimitiveMetadataAccessPolicy.CONSTRUCTOR)).toBe(MetadataNotExistencePolicy.DEFAULT);
        expect(policyProvider.getNotExistencePolicy(PrimitiveMetadataAccessPolicy.PARAMETER_IN_CONSTRUCTOR)).toBe(MetadataNotExistencePolicy.SKIP);
        expect(policyProvider.getNotExistencePolicy(PrimitiveMetadataAccessPolicy.PARAMETER_IN_STATIC_METHOD)).toBe(MetadataNotExistencePolicy.SKIP);
        expect(policyProvider.getNotExistencePolicy(PrimitiveMetadataAccessPolicy.PARAMETER_IN_INST_METHOD)).toBe(MetadataNotExistencePolicy.APPLY);

        policyProvider.setNotExistencePolicy(MetadataNotExistencePolicy.SKIP, MetadataAccessPolicy.PARAMETER_IN_INST_METHOD);
