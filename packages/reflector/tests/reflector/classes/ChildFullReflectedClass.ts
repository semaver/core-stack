...
export class ChildFullReflectedClass extends SuperReflectedClass {
...
// ----------------------------
    @standard("prop isStatic undefined init", 7)
    public static propertyUndefInitStatic?: number = undefined;
    ...
    @standard("prop normal undefined init", 9)
    public propertyUndefInitNormal: unknown = undefined;
