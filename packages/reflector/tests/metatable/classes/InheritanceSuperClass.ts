...
export class InheritanceSuperClass {
    ...
    public static get accessorStaticFull(): string {
        return InheritanceSuperClass._accessorStaticFull;
    }

    @standard("accessor isStatic full set", 4)
    public static set accessorStaticFull(value: string) {
        InheritanceSuperClass._accessorStaticFull = value;
    }
    ...
    public static propertyUndefNonDecoratedStatic: number;
    public static propertyDefNonDecoratedStatic: number = 0;
    ...
    public propertyDefNonDecoratedNormal: number = 9;
    public propertyUndefNonDecoratedNormal?: number;
    public propertyNullNonDecoratedNormal: unknown = null;
    ...
    @standard("method normal with no param", 1)
    public runNormalWithNoParam(): number {
        return -1;
    }
